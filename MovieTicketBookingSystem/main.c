...
void ticket1(int choice,char name[10],int id2,int price)
{
        ...
        printf("\t============================================================\n");
        printf("\t Booking ID : %d \t\t\tShow Name : Adventure of Sundarbans\n",id2);
        printf("\t Customer  : %s\n",name);
        printf("\t\t\t                              Date      : 16-05-2024\n");
        printf("\t                                              Time      : 08:00pm\n");
        printf("\t                                              Hall      : 02\n");
        printf("\t                                              seats No. : %d  \n",choice);
        printf("\t                                              price . : %d  \n\n",price);
...
int movie(void)
{
	...
	printf("\t\t\t----------------------------\n\n");
	printf("\t\t\tpress 1 for Adventure of Sundarbans\n\n");
	printf("\t\t\tpress 2 for MR-9: Do or Die\n\n");
...
void ticket2(int choice,char name[10],int id2,int price)
{
        ...
        printf("\t-----------------THEATER BOOKING TICKET----------------\n");
        printf("\t============================================================\n");
        printf("\t Booking ID : %d \t\t\tShow Name : MR-9: Do or Die\n",id2);
        printf("\t Customer  : %s\n",name);
        printf("\t\t\t                              Date      : 16-05-2024\n");
        printf("\t                                              Time      : 09:00pm\n");
        printf("\t                                              Hall      : 03\n");
...
{
    FILE *file = fopen("details.txt", "a"); // Open file in append mode
    if (file == NULL)
    {
    ...
    {
        fprintf(file, "Booking ID: %d\t", person[i].id);
        fprintf(file, "Customer Name: %s\t", person[i].name);
        fprintf(file, "Customer Phone Number: %s\t", person[i].phone);
        fprintf(file, "Seat Number: %d\n", person[i].seat);
    }

    fclose(file);
    printf("Details saved to details.txt file successfully.\n");
}
